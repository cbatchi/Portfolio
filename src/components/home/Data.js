...
import { Button } from "../../styles/components/components.styled"
...
const Data = () => {
  return (
    <div className="home__data">
      ...
      <HomeDescription>
        i'm creative front end developer based in toulouse region, and i'm very
        passionnate and dedicated to my work
      </HomeDescription>
...
const HomeSubTitle = styled.h3`
  position: relative;
  font-size: ${({ theme }) => theme?.font?.size?.h3} / 2;
  padding-left: 5.4rem;
  font-weight: ${({ theme }) => theme?.font?.weight?.normal};
  margin-bottom: ${({ theme }) => theme?.block?.margin?.b1};
...
const HomeTitle = styled.h1`
  ...
  margin-bottom: ${({ theme }) => theme?.block?.margin?.b0_25};
...
const HomeDescription = styled.p`
  max-width: 400px;
  margin-bottom: ${({ theme }) => theme?.block?.margin?.b3};
